const data = [
  {
    ...
    time: 'Time: 2.5 Years',
    tools: 'Tools: React, Javascript, HTML, Invision, Sketch, Photoshop, Adobe Illustrator',
  },
  {
    title: 'Lagna',
  ...
  },
  {
    ...
    link: '/cmu',
    image: '/images/projects/cmu.png',
    date: '2023-07-03',
    desc: 'Working with cross-functional Agile team to build web applications to support the CMU online presence in collaboration with the marketing department.',
    team: 'Team: Namrata Kulkarni and 5 Others',
    role: 'Role: Web Developer',
    client: 'Client: CMU',
    time: 'Time: 4 Months',
    tools: 'Tools: CMS, Figma, React, Javascript, HTML',
  },
  {
    title: 'UPitt',
    subtitle: 'Website Development',
    link: '/upitt',
    image: '/images/projects/upitt.jpg',
    date: '2023-07-03',
    desc: 'Working with cross-functional Agile team to build web applications to support the UPitt online presence in collaboration with the marketing department.',
    team: 'Team: Namrata Kulkarni and 3 Others',
    role: 'Role: Web Developer',
    client: 'Client: UPitt',
    time: 'Time: Ongoing',
